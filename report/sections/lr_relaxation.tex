Lagrangian relaxation (LR) has been used extensively in CFLP problems \cite{cornuejols1991comparison}. It is 
...
the objective function, obtaining the LR ESLP. The capacity constraint is chosen for 
relaxation as it is this constraint which couples this problem's decision variables,
therefore adding additional complexity to the problem.
...
where $Z(x,y)$ is the objective function in the original ESLP \eqref{eq:ESLP_obj}.
